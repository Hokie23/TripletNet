...
CUDA_VISIBLE_DEVICES=0 th MainStaticsDistance.lua -modelsFolder "./Results/FriApr817:32:232016/" -network tripletnet.best.net.t7 -output distance_pair_128_att_0411.csv
