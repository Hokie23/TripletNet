...
#CUDA_VISIBLE_DEVICES=3 th Main.lua -port 8801 -distance_ratio 0.001 -distance_increment 0.0003
CUDA_VISIBLE_DEVICES=3 th Main.lua -port 8801 -distance_ratio 0.001 -distance_increment 0.001
