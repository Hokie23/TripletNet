...
#CUDA_VISIBLE_DEVICES=3 th MainLoadFeature.lua -feature_list ./result_128D_fashion.epoch1.out -model './Results/WedApr2714:53:202016/tripletnet.best.t7.epoch1' 
